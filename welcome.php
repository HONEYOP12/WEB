...
<body>
    ...
    <header>
        ...
        <nav class="navbar">
          ...
          <a href="#doctor">Staff</a>
          <a href="./img gallery/index.html" target="_blank">Photo Gallery</a>
          <a href="https://www.youtube.com/channel/UCoATVCn7bLEJVP91oHBEvhg" target="_blank">Blog</a>
          <a href="H:\PAPA SCHOOL WEBSITE PART 2\Responsive Contact Us Form/index.html" target="_blank"><i class="fa fa-phone" aria-hidden="true"></i></a>
    ...
    <div class="column">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href=":\PAPA SCHOOL WEBSITE PART 2\Teachers\RajaRam Dewangan/index.html" target=_blank>View More</a>
            </div>
            <div class="box">
                <img src="images/wash-b.png" alt="">
                <h3>Mrs. Shilpi Sarkar</h3><br>
                 <a href=":\PAPA SCHOOL WEBSITE PART 2\Teachers\Shilpi Sarkar/index.html" target=_blank>View More</a>
            </div>

            <div class="box">
                <img src="images/wash-c.png" alt="">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h3>Pooja Singh</h3><br>
                 <a href=":\PAPA SCHOOL WEBSITE PART 2\Teachers\Pooja Singh/index.html" target=_blank>View More</a>
            </div>

            <div class="box">
                <img src="images/wash-d.png" alt="">
                <h3>Mr. Jaydev Pandey</h3><br>
                 <a href=":\PAPA SCHOOL WEBSITE PART 2\Teachers\Mr. Jaydev Pandey/index.html" target=_blank>View More</a>
            </div>

            <div class="box">
                <img src="images/wash-e.png" alt="">
                <h3>Mr. Sanjay Singh</h3><br>
                 <a href=":\PAPA SCHOOL WEBSITE PART 2\Teachers\Mr. Sanjay Singh/index.html" target=_blank>View More</a>
            </div>

            <div class="box">
                <img src="images/wash-f.png" alt="">
                <h3>Zennat Khatun</h3><br>
                 <a href=":\PAPA SCHOOL WEBSITE PART 2\Teachers\Zennat Khatun/index.html" target=_blank>View More</a>
            </div>
            <div class="box">
                <img src="images/wash-f.png" alt="">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h3>Mr. Mintu Kumar</h3><br>
                 <a href=":\PAPA SCHOOL WEBSITE PART 2\Teachers\Mr. Mintu Kumar/index.html" target=_blank>View More</a>
            </div>
            <div class="box">
                <img src="images/wash-f.png" alt="">
                <h3>Brahamdut Shukla</h3><br>
                 <a href=":\PAPA SCHOOL WEBSITE PART 2\Teachers\Brahamdut Shukla/index.html" target=_blank>View More</a>
            </div>
            <div class="box">
                <img src="images/wash-f.png" alt="">
                <h3>Bhagat Singh</h3><br>
                 <a href="H:\PAPA SCHOOL WEBSITE PART 2\Teachers\Brahamdut Shukla/index.html" target=_blank>View More</a>
            </div>
            <div class="box">
                <img src="images/wash-f.png" alt="">
...
<body>
    <div class="container">
      ...
      <div class="box">
        ...
        <div class="right">
          <div class="text-1">Shashi Rai</div>
